package com.rain.learning.grpc.manualflowcontrol;
...
public final class StreamingGreeterGrpc {
  ...
  @java.lang.Deprecated // Use {@link #getSayHelloStreamingMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.rain.learning.grpc.manualflowcontrol.HelloRequest,
      com.rain.learning.grpc.manualflowcontrol.HelloReply> METHOD_SAY_HELLO_STREAMING = getSayHelloStreamingMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.rain.learning.grpc.manualflowcontrol.HelloRequest,
      com.rain.learning.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.rain.learning.grpc.manualflowcontrol.HelloRequest,
      com.rain.learning.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod() {
    return getSayHelloStreamingMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.rain.learning.grpc.manualflowcontrol.HelloRequest,
      com.rain.learning.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethodHelper() {
    io.grpc.MethodDescriptor<com.rain.learning.grpc.manualflowcontrol.HelloRequest, com.rain.learning.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;
      ...
      synchronized (StreamingGreeterGrpc.class) {
        if ((getSayHelloStreamingMethod = StreamingGreeterGrpc.getSayHelloStreamingMethod) == null) {
          StreamingGreeterGrpc.getSayHelloStreamingMethod = getSayHelloStreamingMethod = 
              io.grpc.MethodDescriptor.<com.rain.learning.grpc.manualflowcontrol.HelloRequest, com.rain.learning.grpc.manualflowcontrol.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "manualflowcontrol.StreamingGreeter", "SayHelloStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rain.learning.grpc.manualflowcontrol.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rain.learning.grpc.manualflowcontrol.HelloReply.getDefaultInstance()))
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.rain.learning.grpc.manualflowcontrol.HelloRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<com.rain.learning.grpc.manualflowcontrol.HelloReply> responseObserver) {
      return asyncUnimplementedStreamingCall(getSayHelloStreamingMethodHelper(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getSayHelloStreamingMethodHelper(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.rain.learning.grpc.manualflowcontrol.HelloRequest,
                com.rain.learning.grpc.manualflowcontrol.HelloReply>(
  ...
  public static final class StreamingGreeterStub extends io.grpc.stub.AbstractStub<StreamingGreeterStub> {
    ...
    public io.grpc.stub.StreamObserver<com.rain.learning.grpc.manualflowcontrol.HelloRequest> sayHelloStreaming(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getSayHelloStreamingMethodHelper(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static abstract class StreamingGreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.rain.learning.grpc.manualflowcontrol.HelloStreamingProto.getDescriptor();
    }
      ...
      synchronized (StreamingGreeterGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSayHelloStreamingMethodHelper())
              .build();
        }
      }
    }
